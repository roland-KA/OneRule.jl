...
It has been extended to offer full functionality (e.g. for predicting) and it has been adapted to conform to common ML interfaces. It's now part of the meta-package [MLJ.jl](https://alan-turing-institute.github.io/MLJ.jl/dev/)).
